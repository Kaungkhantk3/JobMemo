...
import { summarizeApplicationStatuses } from "@/lib/applications";
...
export default async function DashboardPage() {
  ...
  const dashboardSummary: DashboardSummary = {
    ...summarizeApplicationStatuses(dashboardApplications),
    pendingReview: await prisma.gmailEmailReview.count({
      where: {
        userId: session.user.id,
        hidden: false,
        applicationId: null,
